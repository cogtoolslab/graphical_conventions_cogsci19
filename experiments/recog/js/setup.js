...
var instructionsHTML = {
  'str1' : "<p> Here's how the game will work: On each trial, you will see a sketch appear above four images of different objects. Your goal is to select the object in the set that best matches the sketch. <div id='example_screen'><img src='../images/recog_screen_cap.png'></div>",
