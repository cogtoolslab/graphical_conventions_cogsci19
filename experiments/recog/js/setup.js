...
var instructionsHTML = {
  ...
  'str2' : '<p> For each correct guess you make, you will receive an <b>accuracy bonus</b> of $0.03. <p> In addition, you will receive a <b>speed bonus</b> (up to $0.01) based on how fast you make the correct guess. In other words, the faster you can select the correct object, the larger the bonus you will receive. </p> <p> However, you <i> must select the correct object to receive any bonus at all </i>, so please pay attention and above all <b> aim to be as accurate as you can </b>! </p>',
