...
var game_core = function(options){
  ...
  this.iterationName = 'run5_submitButton'; // ['run0_bonusmeter','run1_chairsOnly','run2_chairs1k_size4','run2_chairs1k_size6', 'run3_size6_waiting','run3_size4_waiting','run4_generalization']
