...
def plot_bis_scores(D_filtered):
    ...
    drawDuration_accuracy_bis_repeated.to_csv("graphical_conventions_{}_{}_{}".format('bis_score', 'drawDuration', 'repeated'))
    numStrokes_accuracy_bis_repeated.to_csv("graphical_conventions_{}_{}_{}".format('bis_score', 'numStrokes', 'repeated'))
