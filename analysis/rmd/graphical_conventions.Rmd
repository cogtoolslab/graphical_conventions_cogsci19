...
d.bis.drawDuration <- read_csv('../../results/graphical_conventions_bis_score_drawDuration.csv')  %>% select(-X1) %>% distinct()
d.bis.numStrokes <- read_csv('../../results/graphical_conventions_bis_score_numStrokes.csv') %>% select(-X1) %>% distinct()
```
...
ggsave('../../writing/cogsci19/bis_score.pdf', width=20, height = 15, units='cm')
