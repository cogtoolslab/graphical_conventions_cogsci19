...
```{r}
d <- read_csv('../../results/csv/graphical_conventions_group_data_run5_submitButton.csv')  %>% select(-png)
d.bis.drawDuration <- read_csv('../../results/csv/graphical_conventions_bis_drawDuration_run5_submitButton.csv')  %>% select(-X1)
d.bis.numStrokes <- read_csv('../../results/csv/graphical_conventions_bis_numStrokes_run5_submitButton.csv') %>% select(-X1)
```
